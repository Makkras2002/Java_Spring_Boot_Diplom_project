...
public class RequestToSupport extends CustomEntity {
    ...
    public RequestToSupport(String requestMessage, String responseMessage, User requester, User responder) {
    ...
    public RequestToSupport(Long requestId, String requestMessage, String responseMessage, User requester, User responder) {
