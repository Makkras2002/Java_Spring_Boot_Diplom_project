    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/","/pictures/**","/catalog","/aboutUs","/js/**",
                        "/css/**","/search","/sortCatalog","/favicon.png","/prod_pics/**")
                .permitAll()
                .antMatchers("/employeeMain","/clientsOrders","/stockRefillOrders","/statistics","/finances",
                        ...
                        "/changeUserAuthority","/changeActivityStatus", "/sortUsers","/searchUsers",
                        "/updateExpensesData","/deleteExpensesData","/addExpenses","/changeFinances","/sortExpenses",
                        "/clientsOrders/exportExcel")
                ...
                .antMatchers("/register","/regconfirm","/sendCodeToEmail","/restorePassword")
                .hasAuthority("GUEST")
                .anyRequest()
                .authenticated()
                .and()
